...
export declare class Canvas2DBaseRenderable extends Canvas2DElement {
    #private;
     ...
     * @private
     */
    registerChange<P extends keyof this, V extends this[P]>(propertyName: P, newValue: V): void;
    /**
     * @private
     */
