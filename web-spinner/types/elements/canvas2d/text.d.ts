...
declare const Base_base: {
    ...
    new (...args: any[]): {
        "__#30@#fontFamily": string | null;
        "__#30@#kerning": CanvasFontKerning | null;
        "__#30@#size": number | null;
        "__#30@#sizeUnit": "cm" | "mm" | "Q" | "in" | "pc" | "pt" | "px" | "vh" | "vw" | "em" | "cap" | "ch" | "ex" | "ic" | "lh" | "rcap" | "rch" | "rem" | "rex" | "rlh";
        "__#30@#stretch": CanvasFontStretch | null;
        "__#30@#fontStyle": ("normal" | `oblique ${number}deg` | `oblique ${number}rad` | `oblique ${number}grad` | `oblique ${number}turn` | "italic" | "oblique") | null;
        attributeChangedCallback(name: string, oldValue: string | null, newValue: string | null): void;
