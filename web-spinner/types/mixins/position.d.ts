...
export declare function positioned<B extends typeof Canvas2DBaseRenderable>(Base: B): {
    new (...args: any[]): {
        "__#220653@#position": Vector2D;
        attributeChangedCallback(name: string, oldValue: string | null, newValue: string | null): void;
        movePosition(x: number, y: number): void;
        "__#220653@#positionChangeListener": ChangeListener<Vector2D>;
        position: Vector2D;
        "__#81961@#changedSinceRender": boolean;
        "__#81961@#clickListeners": Set<EventListenerOrEventListenerObject>;
        "__#81961@#localMouse": import("../classes/mouse").MouseData;
        "__#81961@#mouseListeners": Set<EventListenerOrEventListenerObject>;
        ...
        "__#81961@#handleClick"(canvas2D: import("../elements/canvas2d/canvas").Canvas2DCanvasElement): void;
        "__#81961@#handleMouse"(canvas2D: import("../elements/canvas2d/canvas").Canvas2DCanvasElement): void;
        ...
        "__#865011@#everyFrame": Updater | null;
