...
export declare function standalone<B extends typeof Canvas2DRenderable>(Base: B): {
    new (...args: any[]): {
        renderSelf(context: CanvasRenderingContext2D, frame: number): void;
        "__#142359@#changedSinceRender": boolean;
        ...
        "__#142360@#everyFrame": Updater | null;
        attributeChangedCallback(name: string, oldValue: string | null, newValue: string | null): void;
        createChild<T extends keyof Canvas2DElementTagMap>(tag: T): (options?: Partial<Canvas2DElementTagMap[T]> | undefined) => Canvas2DElementTagMap[T];
        ...
        readonly rectangle: (options?: Partial<import("../elements/canvas2d/rectangle").Canvas2DRectangle> | undefined) => import("../elements/canvas2d/rectangle").Canvas2DRectangle;
        readonly text: (options?: Partial<Canvas2DText> | undefined) => Canvas2DText;
        accessKey: string;
