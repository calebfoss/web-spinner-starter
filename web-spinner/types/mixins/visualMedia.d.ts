...
export declare function rendersVisualMedia<B extends typeof Canvas2DBaseRenderable, T extends "img" | "video">(Base: B, mediaTag: T): {
    new (...args: any[]): {
        "__#29@#mediaElement": HTMLElementTagNameMap[T];
